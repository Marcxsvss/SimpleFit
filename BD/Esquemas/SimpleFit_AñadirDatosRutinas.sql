...
('marcos@gmail.com','12345678','50397394Y','marcos','184','82','16-28','Masculino','ectomorfo',2);
 ...
 VALUES
(1, 'Upper-Lower Split', 'Divide los entrenamientos en dos días: uno para la parte superior del cuerpo y otro para la parte inferior.', 4, 3, 'Intermedia'),
...
(8, 'HIIT', 'Alterna entre períodos cortos de ejercicio intenso y períodos de recuperación o ejercicio de baja intensidad.', 4, 3, 'Intermedia'),
