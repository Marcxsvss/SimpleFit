...
public class Usuarios implements Serializable {
    ...
    public Usuarios(String email, String password, String nombre, String altura, String peso, String edad, String sexo, String somatotipo, Integer rutinastate, Integer acceso, String foto) {
        this.email = email;
