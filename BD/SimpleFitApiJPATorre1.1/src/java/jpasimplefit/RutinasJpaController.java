...
public class RutinasJpaController implements Serializable {
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            Collection<Usuarios> usuariosCollection = rutinas.getUsuariosCollection(); //Esto creo que hay que meterlo en el destroy de usuarios, para que borre tmbn la rutina, no solo la relacion del usuario
